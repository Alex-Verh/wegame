...
<template>
    ...
    <b-container>
        <b-row class="g-5">
            <b-col cols="3">
                <img class="profile_picture" src="../../assets/profile.jpg" alt="Profile Username">
            ...
            <b-col cols="9">
                ...
                <b-container>
                    ...
                    <div class="profile_subtitle">Applications - <span class="profile_createapp">Create New</span></div>
                    <div class="profile_section d-flex flex-row">
                        <div class="profile_box d-inline-flex align-items-center">
                            ...
                            <img src="../../assets/trash.svg" class="profile_box_trash" alt="Delete">
                        </div>
                        <div class="profile_box d-inline-flex align-items-center">
                            Looking for a cool CS 2 player, preferably higher than gold nova 1 and know russian.
                            <img src="../../assets/trash.svg" class="profile_box_trash" alt="Delete">
